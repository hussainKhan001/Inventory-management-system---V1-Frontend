...
const PortalCard = /* @__PURE__ */ __name(({
  ...
  href={`#${to.replace("/", "")}`}
  whileHover={{ y: -5 }}
  className="group relative block bg-white dark:bg-gray-900 border border-[#E8ECF0] dark:border-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer"
>
    ...
    <div className="inline-flex items-center gap-2 text-sm font-bold text-[#F97316] group-hover:gap-3 transition-all">
      Open Form <ArrowRight className="w-4 h-4" />
    </div>
  </motion.a>, "PortalCard");
const PublicPortal = /* @__PURE__ */ __name(() => {
  ...
  return <div className="min-h-screen bg-[#F9FAFB] dark:bg-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {allForms.map((form, index) => <motion.div
    key={form.to}
