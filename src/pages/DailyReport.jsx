...
const DailyReport = /* @__PURE__ */ __name(() => {
  ...
  useEffect(() => {
    fetchResource("transactions", 1, 1e4, false, "", null, false, false, selectedDate, selectedDate);
  ...
  const downloadPDF = /* @__PURE__ */ __name(() => {
    ...
    doc.text(`Generated At: ${(/* @__PURE__ */ new Date()).toLocaleString()}`, 14, 38);
  ...
  />
      ...
      <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 h-[650px] flex flex-col overflow-hidden">
        <div className="flex-1 min-h-0 relative">
          {reportData.length > 0 ? <TableVirtuoso
    data={reportData}
    style={{ height: "100%", width: "100%" }}
    components={{
      Table: /* @__PURE__ */ __name((props) => <table {...props} className="w-full text-left text-[13px] border-collapse" />, "Table"),
      TableRow: /* @__PURE__ */ __name((props) => <tr {...props} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors divide-x divide-gray-100 dark:divide-gray-800" />, "TableRow"),
  ...
  /> : <div className="h-full flex flex-col">
        ...
        {loading && <div className="absolute inset-x-0 bottom-0 p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-t border-gray-100 dark:border-gray-800 z-20">
