...
const PERMISSION_GROUPS = [
  ...
  },
  {
    id: "catalogue",
    name: "Catalogue",
    perms: ["VIEW_CATALOGUE", "CREATE_CATALOGUE", "EDIT_CATALOGUE", "DELETE_CATALOGUE", "VIEW_RECYCLE_BIN_CATALOGUE", "RESTORE_CATALOGUE"]
  },
  {
    id: "suppliers",
    name: "Suppliers",
    perms: ["VIEW_SUPPLIERS", "CREATE_SUPPLIER", "EDIT_SUPPLIER", "DELETE_SUPPLIER", "VIEW_RECYCLE_BIN_SUPPLIER", "RESTORE_SUPPLIER"]
  },
  {
    id: "inventory",
    name: "Inventory",
    perms: ["VIEW_INVENTORY", "CREATE_INVENTORY", "EDIT_INVENTORY", "DELETE_INVENTORY", "VIEW_RECYCLE_BIN_INVENTORY", "RESTORE_INVENTORY"]
  },
  {
    id: "planning",
    name: "Material Planning",
    perms: ["VIEW_MATERIAL_PLAN", "CREATE_MATERIAL_PLAN", "EDIT_MATERIAL_PLAN", "DELETE_MATERIAL_PLAN", "APPROVE_MATERIAL_PLAN", "REJECT_MATERIAL_PLAN", "VIEW_RECYCLE_BIN_MATERIAL_PLAN", "RESTORE_MATERIAL_PLAN"]
  },
  {
    id: "mp_plan",
  ...
  },
  {
    ...
    perms: [
      ...
      "VIEW_RECYCLE_BIN_MATERIAL_REQUIREMENT",
      "RESTORE_MATERIAL_REQUIREMENT"
    ]
  },
  {
    id: "quotations",
    name: "Quotations",
    perms: ["VIEW_QUOTATIONS", "CREATE_QUOTATION", "EDIT_QUOTATION", "DELETE_QUOTATION", "APPROVE_QUOTATION", "REJECT_QUOTATION", "VIEW_QUOTATION_DETAILS", "VIEW_RECYCLE_BIN_QUOTATION", "RESTORE_QUOTATION"]
  },
  {
    id: "pos",
    ...
    perms: [
      ...
      "HOLD_PURCHASE_ORDER",
      "APPROVE_PO_REVISION",
      "VIEW_RECYCLE_BIN_PURCHASE_ORDER",
  ...
  },
  {
    ...
    perms: ["APPROVE_EMR", "DELETE_EMR", "VIEW_RECYCLE_BIN_EMR", "RESTORE_EMR"]
  },
  {
    id: "grn",
    name: "GRN",
    perms: ["VIEW_GRN", "CREATE_GRN", "EDIT_GRN", "EDIT_GRN_RECEIPT", "DELETE_GRN", "VIEW_RECYCLE_BIN_GRN", "RESTORE_GRN"]
  },
  {
    id: "inward",
    name: "Inward",
    perms: ["VIEW_INWARD", "CREATE_INWARD", "EDIT_INWARD", "DELETE_INWARD", "VIEW_RECYCLE_BIN_INWARD", "RESTORE_INWARD"]
  },
  {
    id: "outward",
    name: "Outward",
    perms: ["VIEW_OUTWARD", "CREATE_OUTWARD", "EDIT_OUTWARD", "DELETE_OUTWARD", "VIEW_RECYCLE_BIN_OUTWARD", "RESTORE_OUTWARD"]
  },
  {
    id: "inward_return",
    name: "Inward Return",
    perms: ["VIEW_INWARD_RETURN", "CREATE_INWARD_RETURN", "EDIT_INWARD_RETURN", "DELETE_INWARD_RETURN", "VIEW_RECYCLE_BIN_INWARD_RETURN", "RESTORE_INWARD_RETURN"]
  },
  {
    id: "outward_return",
    name: "Outward Return",
    perms: ["VIEW_OUTWARD_RETURN", "CREATE_OUTWARD_RETURN", "EDIT_OUTWARD_RETURN", "DELETE_OUTWARD_RETURN", "VIEW_RECYCLE_BIN_OUTWARD_RETURN", "RESTORE_OUTWARD_RETURN"]
  },
  {
    id: "transfer_inward",
  ...
  },
  {
    id: "write_offs",
    name: "Write Offs",
    perms: ["VIEW_WRITE_OFFS", "CREATE_WRITE_OFF", "EDIT_WRITE_OFF", "DELETE_WRITE_OFF", "APPROVE_WRITE_OFF", "VIEW_RECYCLE_BIN_WRITE_OFF", "RESTORE_WRITE_OFF"]
  },
  {
    id: "stock_check",
    name: "Stock Check",
