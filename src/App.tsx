...
// ── Hex → RGB helper (for theme color CSS var) ────────────────────────────────
...
const AppContent = () => {
  ...
  useEffect(() => {
    if (settings) {
      ...
      if (settings.faviconUrl) {
        ...
        const fullUrl = settings.faviconUrl.startsWith('/uploads')
  ...
  const renderPage = () => {
    ...
    switch (hash) {
      ...
      case "users-manage":         return <SuperAdmin />;
      case "audit-logs":           return <AuditLogs />;
      case "catalogue":            return <Catalogue />;
      case "suppliers":            return <Suppliers />;
      case "inventory":            return <Inventory />;
      case "planning":             return <MaterialPlanning />;
      case "pos":                  return <PurchaseOrders />;
      case "accounts":             return <AccountsPage />;
      case "grn":                  return <GRNPage />;
      case "inward":               return <TransactionsPage type="Inward" />;
      case "outward":              return <TransactionsPage type="Outward" />;
      case "inward-returns":       return <TransactionsPage type="Inward Return" />;
      case "outward-returns":      return <TransactionsPage type="Outward Return" />;
      case "transfer-inward":      return <TransactionsPage type="Transfer Inward" />;
      case "transfer-outward":     return <TransactionsPage type="Transfer Outward" />;
      case "material-requirements":return <MaterialRequirementPage />;
      case "quotations":           return <Quotations />;
      case "writeoffs":            return <WriteOffPage />;
      case "stockcheck":           return <StockCheck />;
      case "stockcheck-reports":   return <StockCheckReports />;
