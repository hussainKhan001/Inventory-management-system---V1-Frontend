...
const CustomDropdown = React.memo(({
  ...
  const handleToggle = /* @__PURE__ */ __name(() => {
    if (!isOpen && containerRef.current) {
      ...
      const shouldOpenUpward = spaceBelow < 240;
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          style={dropdownStyle}
          className={cn(
            "min-w-[150px] bg-white/95 dark:bg-[#1E293B]/95 backdrop-blur-md border border-gray-200/85 dark:border-gray-700/85 rounded-md shadow-xl dark:shadow-2xl dark:shadow-black/70 overflow-hidden",
            dropdownClassName
          )}
        >
