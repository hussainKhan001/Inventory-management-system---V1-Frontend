...
const SearchFilter = React.memo(({
  ...
  return <div className={cn("relative flex-1 min-w-[200px]", className)}>
...
const DateFilter = React.memo(({
  ...
  return <div className={cn("relative flex-1 min-w-[120px]", className)}>
...
const SelectFilter = React.memo(({
  ...
  return <div ref={containerRef} className={cn("relative flex-1 min-w-[140px] group", className)}>
    ...
    className={cn(
      ...
      isOpen ? "border-[#F97316] ring-4 ring-[#F97316]/20 text-[#1A1A2E] dark:text-[#F1F5F9]" : "border-gray-200/50 dark:border-gray-800 text-[#1A1A2E] dark:text-[#F1F5F9] hover:border-gray-300 dark:hover:border-gray-700"
    )}
  >
...
const FilterRow = React.memo(({
  ...
  return <div className={cn("flex flex-wrap items-center gap-3 sm:gap-4 w-full", className)}>
      {children}
    </div>;
});
